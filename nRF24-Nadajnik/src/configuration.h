...
#define PAUSE_AFTER_GWIZD   2000    // jesli wykryje gwizdniecie nie wysyla sygnalu przez podany czas


// Ustawienia czujnika BME
#define BME_AVG_COUNT 20      // wiecej -> dluzszy powrot avg do normy
#define BME_AVG_DIFF  1000     // Im mniej tym dluzej wylacza sie po dmuchaniu. Zbyt malo powoduje ze mimo wylaczenia sie gwizdka, wlacza sie ponownie gdy wartosci wracaja do normy i avg.
